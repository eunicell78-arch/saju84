...
# 각 항목의 구조:
# - bits 0-3 (하위 4비트): 윤달 위치 (0=윤달없음, 1-12=해당 월이 윤달)
# - bits 4-15 (12비트): 각 달의 크기 (0=29일, 1=30일)
#   * bit 15 = 1월, bit 14 = 2월, ..., bit 4 = 12월
# - bit 16 (최상위 비트): 윤달 크기 (0=29일, 1=30일)
LUNAR_INFO = [
    0x04bd8,  # 1900
...
def get_lunar_month_days(year: int, month: int) -> int:
    ...
    # bit 15가 1월, bit 14가 2월, ..., bit 4가 12월
    # 0x8000 >> (month - 1)로 해당 월의 비트를 체크
